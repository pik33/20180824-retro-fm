...
.section .text.n_midi$_$openmidi_$$_fin$9,"x"
	.balign 16,0x90
MIDI$_$OPENMIDI_$$_fin$9:
.Lc10:
.seh_proc MIDI$_$OPENMIDI_$$_fin$9
.Ll21:
# [102] begin
	pushq	%rbp
.seh_pushreg %rbp
...
# [92:1]
	...
	.byte	1
# ###################
# function: MIDI$_$OPENMIDI_$$_fin$9
# [102:1]
	.byte	0
	.uleb128	9
	.byte	2
