...
# PeepHole Optimization,var2a
.Ll36:
# [149] waves1[sampleindex1].wave:=getmem(4*sampleinfo[i].slen);
	movl	%ebx,%eax
	imulq	$40,%rax,%rax
	movl	-2192(%rbp,%rax),%ecx
	shlq	$2,%rcx
...
# PeepHole Optimization,var2a
.Ll46:
# [160] waves1[sampleindex1].lend:=((sampleinfo[i].sls+sampleinfo[i].sll) div 2)-1;
	movl	%ebx,%eax
	imulq	$40,%rax,%rax
	movl	-2188(%rbp,%rax),%edx
# PeepHole Optimization,var2a
	movl	%ebx,%eax
	imulq	$40,%rax,%rax
...
.Lj326:
	...
	movq	-16(%rbp),%rdx
	movl	-24(%rbp),%ecx
	movl	_$FMSYNTH$_Ld10(%rip),%eax
	movl	%eax,136(%rdx,%rcx,4)
	cmpl	$7,-24(%rbp)
	jl	.Lj326
.Ll72:
# [194] operators[0].mul1:=16384;
	movq	-16(%rbp),%rax
	movq	8(%rax),%rax
	movq	_$FMSYNTH$_Ld11(%rip),%rdx
	movq	%rdx,80(%rax)
.Ll73:
# [195] operators[1].mul1:=10000;
	movq	-16(%rbp),%rax
	movq	16(%rax),%rax
	movq	_$FMSYNTH$_Ld12(%rip),%rdx
	movq	%rdx,80(%rax)
.Ll74:
# [196] operators[0].freq:=150; //440*(65536/192000);  ;
	movq	-16(%rbp),%rax
	movq	8(%rax),%rax
	movq	_$FMSYNTH$_Ld13(%rip),%rdx
	movq	%rdx,8(%rax)
.Ll75:
# [197] operators[1].freq:=300; //2*testvoice.operators[0].freq  ;
	movq	-16(%rbp),%rax
	movq	16(%rax),%rdx
	movq	_$FMSYNTH$_Ld14(%rip),%rax
	movq	%rax,8(%rdx)
.Ll76:
	cmpq	$0,-16(%rbp)
	je	.Lj292
...
# PeepHole Optimization,var2a
.Ll80:
# [208] outputs[i]:=operators[i].getsample;
	movl	%esi,%eax
...
# Var i located in register edx
.Ll83:
# [210] for i:=0 to 7 do output+=outmuls[i]*outputs[i];
	movl	$0,%edx
	subl	$1,%edx
	.balign 8,0x90
.Lj362:
...
# Var q2 located in register xmm2
.Ll87:
# [225] q2:= 0.99989460157410704627595119007091;
	movsd	_$FMSYNTH$_Ld16(%rip),%xmm2
# Var i located in register edx
.Ll88:
# [226] for i:=65540 downto 0 do
	movl	$65540,%edx
	addl	$1,%edx
	.balign 8,0x90
.Lj375:
	subl	$1,%edx
.Ll89:
# [228] if i>65535 then flogtable[i]:=1
	cmpl	$65535,%edx
	jng	.Lj377
# PeepHole Optimization,var2a
	movl	%edx,%eax
	movq	_$FMSYNTH$_Ld15(%rip),%rcx
...
# Var i located in register ebx
.Ll97:
# [244] for i:=-655360 to 655360 do fsinetable[i]:=sin(2*pi*i/1024);
	movl	$-655360,%ebx
	subl	$1,%ebx
	.balign 8,0x90
.Lj391:
	addl	$1,%ebx
	cvtsi2sd	%ebx,%xmm0
	mulsd	_$FMSYNTH$_Ld17(%rip),%xmm0
	mulsd	_$FMSYNTH$_Ld18(%rip),%xmm0
	call	fpc_sin_real
	movslq	%ebx,%rax
...
.Lj422:
.Ll113:
# [267] outputtable:=outs;
	movq	-32(%rbp),%rax
	movq	-16(%rbp),%rdx
	movq	%rdx,312(%rax)
.Ll114:
# [268] if mode=0 then wptr:=@fsinetable;
	cmpl	$0,-8(%rbp)
	jne	.Lj428
	movq	-32(%rbp),%rax
	leaq	U_$FMSYNTH_$$_FSINETABLE(%rip),%rdx
...
# Var i located in register esi
.Ll124:
# [296] for i:=0 to 7 do operators[i].setfreq(afreq);
	movl	$0,%esi
	subl	$1,%esi
	.balign 8,0x90
.Lj462:
...
# PeepHole Optimization,var2a
	...
	jl	.Lj462
.Ll125:
# [298] operators[1].setfreq(1.0043*afreq);
	movsd	_$FMSYNTH$_Ld20(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	16(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll126:
# [299] operators[2].setfreq(1.006*afreq);
	movsd	_$FMSYNTH$_Ld21(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	24(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll127:
# [300] operators[3].setfreq(1.0017*afreq);
	movsd	_$FMSYNTH$_Ld22(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	32(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll128:
# [301] operators[4].setfreq(0.995*afreq);
	movsd	_$FMSYNTH$_Ld23(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	40(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll129:
# [302] operators[5].setfreq(0.991*afreq);
	movsd	_$FMSYNTH$_Ld24(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	48(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll130:
# [303] operators[6].setfreq(0.9939*afreq);
	movsd	_$FMSYNTH$_Ld25(%rip),%xmm1
	mulsd	%xmm6,%xmm1
	movq	56(%rbx),%rcx
	call	FMSYNTH$_$TFMOPERATOR_$__$$_SETFREQ$DOUBLE
.Ll131:
# [304] operators[7].setfreq(0.9961*afreq);
...
# [311] begin
	...
	movapd	%xmm1,%xmm0
.Ll135:
# [312] if wavemode=0 then freq:=afreq*wlength/96000
	cmpl	$0,324(%rax)
	jne	.Lj498
	movapd	%xmm0,%xmm1
	mulsd	144(%rax),%xmm1
	mulsd	_$FMSYNTH$_Ld27(%rip),%xmm1
	movsd	%xmm1,8(%rax)
	jmp	.Lj501
.Lj498:
.Ll136:
...
.Ll164:
# [344] av2:=0.95;
	movq	_$FMSYNTH$_Ld33(%rip),%rdx
	movq	%rdx,200(%rax)
.Ll165:
# [345] av3:=0.9;
	movq	_$FMSYNTH$_Ld34(%rip),%rdx
	movq	%rdx,216(%rax)
.Ll166:
# [346] av4:=0.0;
	movq	_$FMSYNTH$_Ld6(%rip),%rdx
...
.seh_endprologue
.Ll174:
# [377] freq2:=(freq+(c3*lfo1))*c4*lfo2;
	movsd	16(%rcx),%xmm1
	mulsd	48(%rcx),%xmm1
	addsd	8(%rcx),%xmm1
	mulsd	24(%rcx),%xmm1
...
.Ll175:
	movq	312(%rcx),%rax
.Ll176:
# [391] modulator:=outputtable[0]*mul0
	movsd	(%rax),%xmm3
	mulsd	72(%rcx),%xmm3
.Ll177:
# [392] +outputtable[1]*mul1
	movsd	8(%rax),%xmm2
	mulsd	80(%rcx),%xmm2
	addsd	%xmm3,%xmm2
.Ll178:
# [393] +outputtable[2]*mul2
	movsd	16(%rax),%xmm3
	mulsd	88(%rcx),%xmm3
	addsd	%xmm2,%xmm3
.Ll179:
# [394] +outputtable[3]*mul3
	movsd	24(%rax),%xmm2
	mulsd	96(%rcx),%xmm2
	addsd	%xmm3,%xmm2
.Ll180:
# [395] +outputtable[4]*mul4
	movsd	32(%rax),%xmm3
	mulsd	104(%rcx),%xmm3
	addsd	%xmm2,%xmm3
.Ll181:
# [396] +outputtable[5]*mul5
	movsd	40(%rax),%xmm2
	mulsd	112(%rcx),%xmm2
	addsd	%xmm3,%xmm2
.Ll182:
# [397] +outputtable[6]*mul6
	movsd	48(%rax),%xmm3
	mulsd	120(%rcx),%xmm3
	addsd	%xmm2,%xmm3
.Ll183:
# [398] +outputtable[7]*mul7;
	movsd	56(%rax),%xmm2
	mulsd	128(%rcx),%xmm2
	addsd	%xmm3,%xmm2
# Var modulator located in register xmm2
...
# [400] pa:=pa+freq2;
	...
	movsd	%xmm3,288(%rcx)
.Ll185:
# [401] pa2:=pa+modulator;
	movsd	288(%rcx),%xmm3
	addsd	%xmm2,%xmm3
	movsd	%xmm3,296(%rcx)
.Ll186:
# [409] if wavemode=0 then
	cmpl	$0,324(%rcx)
	jne	.Lj581
.Ll187:
# [411] if pa>=wlength then
	movsd	288(%rcx),%xmm3
	comisd	144(%rcx),%xmm3
	jp	.Lj583
	jnae	.Lj583
...
.Lj583:
.Ll189:
# [414] pa2:=pa+modulator;
	movsd	288(%rcx),%xmm3
	addsd	%xmm2,%xmm3
	movsd	%xmm3,296(%rcx)
.Ll190:
# [415] if pa2>=wlength then
	movsd	296(%rcx),%xmm3
	comisd	144(%rcx),%xmm3
	jp	.Lj590
	jnae	.Lj590
...
.Lj592:
.Ll191:
# [416] repeat pa2:=pa2-wlength until pa2<wlength
	movsd	296(%rcx),%xmm3
	subsd	144(%rcx),%xmm3
	movsd	%xmm3,296(%rcx)
	movsd	296(%rcx),%xmm3
...
.Lj602:
.Ll193:
# [418] repeat pa2:=pa2+wlength until pa2>0;
	movsd	296(%rcx),%xmm3
	addsd	144(%rcx),%xmm3
	movsd	%xmm3,296(%rcx)
	movsd	296(%rcx),%xmm3
...
.Lj581:
.Ll194:
# [423] if pa>wlend then
	movsd	288(%rcx),%xmm3
	comisd	160(%rcx),%xmm3
	jp	.Lj610
	jna	.Lj610
.Ll195:
# [424] pa:=pa-wlend+wlstart;
	movsd	288(%rcx),%xmm3
	subsd	160(%rcx),%xmm3
	addsd	152(%rcx),%xmm3
	movsd	%xmm3,288(%rcx)
