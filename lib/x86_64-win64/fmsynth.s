...
.seh_endprologue
.Ll313:
# [517] if (adsrstate=0) then begin sample:=0; goto p999; end;
	cmpl	$0,328(%rcx)
	jne	.Lj1336
...
.Lj1336:
.Ll314:
# [519] freq2:=(freq+(c3*lfo1))*c4*lfo2;
	movsd	16(%rcx),%xmm1
	mulsd	48(%rcx),%xmm1
	addsd	8(%rcx),%xmm1
	mulsd	24(%rcx),%xmm1
...
.Ll315:
	movq	312(%rcx),%rax
.Ll316:
# [523] modulator:=outputtable[0]*mul0
	movsd	(%rax),%xmm9
	mulsd	72(%rcx),%xmm9
.Ll317:
# [524] +outputtable[1]*mul1
	movsd	8(%rax),%xmm1
	mulsd	80(%rcx),%xmm1
	addsd	%xmm9,%xmm1
.Ll318:
# [525] +outputtable[2]*mul2
	movsd	16(%rax),%xmm9
	mulsd	88(%rcx),%xmm9
	addsd	%xmm1,%xmm9
.Ll319:
# [526] +outputtable[3]*mul3
	movsd	24(%rax),%xmm1
	mulsd	96(%rcx),%xmm1
	addsd	%xmm9,%xmm1
.Ll320:
# [527] +outputtable[4]*mul4
	movsd	32(%rax),%xmm9
	mulsd	104(%rcx),%xmm9
	addsd	%xmm1,%xmm9
.Ll321:
# [528] +outputtable[5]*mul5
	movsd	40(%rax),%xmm1
	mulsd	112(%rcx),%xmm1
	addsd	%xmm9,%xmm1
.Ll322:
# [529] +outputtable[6]*mul6
	movsd	48(%rax),%xmm9
	mulsd	120(%rcx),%xmm9
	addsd	%xmm1,%xmm9
.Ll323:
# [530] +outputtable[7]*mul7;
	movsd	56(%rax),%xmm1
	mulsd	128(%rcx),%xmm1
	addsd	%xmm9,%xmm1
.Ll324:
...
# [532] pa:=pa+freq2;
	...
	movsd	%xmm1,288(%rcx)
.Ll326:
# [533] pa2:=pa+modulator;
	movsd	288(%rcx),%xmm1
	addsd	%xmm3,%xmm1
	movsd	%xmm1,296(%rcx)
.Ll327:
# [537] if pa>=wlend then pa:=pa-wlend+wlstart;
	movsd	288(%rcx),%xmm1
	comisd	160(%rcx),%xmm1
	jp	.Lj1351
	jnae	.Lj1351
...
.Lj1351:
.Ll328:
# [538] pa2:=pa+modulator;
	movsd	288(%rcx),%xmm1
	addsd	%xmm3,%xmm1
	movsd	%xmm1,296(%rcx)
.Ll329:
# [539] if pa2>=wlend then
	movsd	296(%rcx),%xmm1
	comisd	160(%rcx),%xmm1
	jp	.Lj1358
	jnae	.Lj1358
...
.Lj1360:
.Ll330:
# [540] repeat pa2:=pa2-wlend+wlstart until pa2<wlend;
	movsd	296(%rcx),%xmm1
	subsd	160(%rcx),%xmm1
	addsd	152(%rcx),%xmm1
	movsd	%xmm1,296(%rcx)
...
.Lj1369:
.Ll332:
# [542] repeat pa2:=pa2+wlength until pa2>=0;
	movsd	296(%rcx),%xmm1
	addsd	144(%rcx),%xmm1
	movsd	%xmm1,296(%rcx)
	movsd	296(%rcx),%xmm1
...
# PeepHole Optimization,MovMov2Mov1
	movl	%eax,336(%rcx)
.Ll334:
# [544] pa21:=intpa+1; if pa21>=wlength then pa21:=trunc(wlstart);
	leal	1(%eax),%eax
	movl	%eax,%edx
	cvtsi2sd	%edx,%xmm1
	comisd	144(%rcx),%xmm1
...
# [548] sample:=(1-d)*sample+d*s2;
	...
	movapd	%xmm9,%xmm4
.Ll339:
# [554] if adsrstate=4 then goto p101;
	cmpl	$4,328(%rcx)
	je	.Lj1394
.Ll340:
# [556] case adsrstate of
	movl	328(%rcx),%eax
	cmpl	$1,%eax
	jl	.Lj1396
	subl	$1,%eax
	...
	jne	.Lj1396
.Ll341:
# [557] 6: if adsrval=0 then adsrstate:=0;
	movsd	168(%rcx),%xmm1
	comisd	_$FMSYNTH$_Ld7(%rip),%xmm1
	jp	.Lj1395
	jne	.Lj1395
...
.Lj1398:
.Ll342:
# [560] adsrval:=adsrval+ar4;
	movsd	168(%rcx),%xmm1
	addsd	224(%rcx),%xmm1
	movsd	%xmm1,168(%rcx)
.Ll343:
# [561] if ar4<0 then begin if adsrval<av4 then begin adsrval:=av4; adsrstate:=6; end; end
	movsd	224(%rcx),%xmm1
	comisd	_$FMSYNTH$_Ld7(%rip),%xmm1
	jp	.Lj1410
	jnb	.Lj1410
...
.Lj1410:
.Ll344:
# [562] else begin if adsrval>av4 then begin adsrval:=av4; adsrstate:=6; end; end;
	movsd	168(%rcx),%xmm1
	comisd	232(%rcx),%xmm1
	jp	.Lj1395
	jna	.Lj1395
...
.Lj1399:
.Ll345:
# [566] adsrval:=adsrval+ar3;
	movsd	168(%rcx),%xmm1
	addsd	208(%rcx),%xmm1
	movsd	%xmm1,168(%rcx)
.Ll346:
# [567] if ar3<0 then begin if adsrval<av3 then begin adsrval:=av3; adsrstate:=4; end; end
	movsd	208(%rcx),%xmm1
	comisd	_$FMSYNTH$_Ld7(%rip),%xmm1
	jp	.Lj1430
	jnb	.Lj1430
...
.Lj1430:
.Ll347:
# [568] else begin if adsrval>av3 then begin adsrval:=av3; adsrstate:=4; end; end;
	movsd	168(%rcx),%xmm1
	comisd	216(%rcx),%xmm1
	jp	.Lj1395
	jna	.Lj1395
...
.Lj1400:
.Ll348:
# [572] adsrval:=adsrval+ar2;
	movsd	168(%rcx),%xmm1
	addsd	192(%rcx),%xmm1
	movsd	%xmm1,168(%rcx)
.Ll349:
# [573] if ar2<0 then begin if adsrval<av2 then begin adsrval:=av2; adsrstate:=3; end; end
	movsd	192(%rcx),%xmm1
	comisd	_$FMSYNTH$_Ld7(%rip),%xmm1
	jp	.Lj1450
	jnb	.Lj1450
...
.Lj1450:
.Ll350:
# [574] else begin if adsrval>av2 then begin adsrval:=av2; adsrstate:=3; end; end;
	movsd	168(%rcx),%xmm1
	comisd	200(%rcx),%xmm1
	jp	.Lj1395
	jna	.Lj1395
...
.Lj1401:
.Ll351:
# [578] adsrval:=adsrval+ar1;
	movsd	168(%rcx),%xmm1
	addsd	176(%rcx),%xmm1
	movsd	%xmm1,168(%rcx)
.Ll352:
# [579] if ar1<0 then begin if adsrval<av1 then begin adsrval:=av1; adsrstate:=2; end; end
	movsd	176(%rcx),%xmm1
	comisd	_$FMSYNTH$_Ld7(%rip),%xmm1
	jp	.Lj1470
	jnb	.Lj1470
...
.Lj1470:
.Ll353:
# [580] else begin if adsrval>av1 then begin  adsrval:=av1; adsrstate:=2; end;  end;
	movsd	168(%rcx),%xmm1
	comisd	184(%rcx),%xmm1
	jp	.Lj1395
	jna	.Lj1395
...
.Ll354:
	movsd	256(%rcx),%xmm9
.Ll355:
# [584] h1:=((1-adsrbias)*adsrval)+adsrbias;
	movsd	_$FMSYNTH$_Ld8(%rip),%xmm1
	subsd	%xmm9,%xmm1
	mulsd	168(%rcx),%xmm1
	addsd	%xmm9,%xmm1
	movapd	%xmm1,%xmm5
.Ll356:
# [585] if adsrstate<>0 then sample:=sample*flogtable[round(65535*h1)] else sample:=0;
	cmpl	$0,328(%rcx)
	je	.Lj1492
...
.Lj1495:
.Ll357:
# [588] h1:=1.000-keysense;
	movsd	_$FMSYNTH$_Ld8(%rip),%xmm1
	subsd	272(%rcx),%xmm1
	movapd	%xmm1,%xmm5
.Ll358:
# [589] h1:=h1+vel*keysense;
	movsd	264(%rcx),%xmm1
	mulsd	272(%rcx),%xmm1
	addsd	%xmm5,%xmm1
	movapd	%xmm1,%xmm5
...
RTTI_$FMSYNTH_$$_PSINGLESTEREOSAMPLE:
	...
	.quad	RTTI_$FMSYNTH_$$_TSINGLESTEREOSAMPLE
