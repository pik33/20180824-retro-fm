...
# [73] outmuls[0]:=1;
	...
	movl	%edx,136(%rax)
.Ll7:
# [74] for i:=1 to 7 do outmuls[i]:=0;
	movl	$1,-24(%rbp)
	subl	$1,-24(%rbp)
	.balign 8,0x90
.Lj42:
...
.Ll11:
# [84] for i:=0 to 7 do outputs[i]:=operators[i].getsample;
	movl	$0,%esi
	subl	$1,%esi
	.balign 8,0x90
.Lj61:
...
# Var i located in register edx
.Ll13:
# [86] for i:=0 to 7 do output+=outmuls[i]*outputs[i];
	movl	$0,%edx
	subl	$1,%edx
	.balign 8,0x90
.Lj70:
...
# Var q2 located in register xmm2
.Ll17:
# [101] q2:= 0.99989460157410704627595119007091;
	movsd	_$FMSYNTH$_Ld5(%rip),%xmm2
# Var i located in register edx
.Ll18:
# [102] for i:=65540 downto 0 do
	movl	$65540,%edx
	addl	$1,%edx
	.balign 8,0x90
.Lj83:
	subl	$1,%edx
.Ll19:
# [104] if i>65535 then flogtable[i]:=1
	cmpl	$65535,%edx
	jng	.Lj85
# PeepHole Optimization,var2a
	movl	%edx,%eax
...
# Var i located in register ebx
.Ll26:
# [119] for i:=0 to 65535 do fsinetable[i]:=sin(2*pi*i/65536);
	movl	$0,%ebx
	subl	$1,%ebx
	.balign 8,0x90
.Lj97:
...
.Lj128:
.Ll42:
# [142] outputtable:=outs;
	movq	-32(%rbp),%rdx
	movq	-16(%rbp),%rax
	movq	%rax,264(%rdx)
.Ll43:
# [143] if mode=0 then wptr:=@fsinetable;
	cmpl	$0,-8(%rbp)
	jne	.Lj134
	movq	-32(%rbp),%rdx
...
# [164] begin
	movq	%rcx,%rax
.Ll53:
# [166] freq:=1000*(65536/192000);    //341
...
# [210] begin
.Ll86:
# [215] freq2:=(freq+(c3*lfo1))*c4*lfo2;
	movsd	16(%rcx),%xmm0
	mulsd	48(%rcx),%xmm0
	addsd	8(%rcx),%xmm0
	mulsd	24(%rcx),%xmm0
...
.Ll88:
# [220] modulator:=foutputtable[0]*mul0
	movsd	(%rax),%xmm2
	mulsd	72(%rcx),%xmm2
.Ll89:
# [221] +foutputtable[1]*mul1
	movsd	8(%rax),%xmm1
	mulsd	80(%rcx),%xmm1
	addsd	%xmm2,%xmm1
.Ll90:
# [222] +foutputtable[2]*mul2
	movsd	16(%rax),%xmm2
	mulsd	88(%rcx),%xmm2
	addsd	%xmm1,%xmm2
.Ll91:
# [223] +foutputtable[3]*mul3
	movsd	24(%rax),%xmm1
	mulsd	96(%rcx),%xmm1
	addsd	%xmm2,%xmm1
.Ll92:
# [224] +foutputtable[4]*mul4
	movsd	32(%rax),%xmm2
	mulsd	104(%rcx),%xmm2
	addsd	%xmm1,%xmm2
.Ll93:
# [225] +foutputtable[5]*mul5
	movsd	40(%rax),%xmm1
	mulsd	112(%rcx),%xmm1
	addsd	%xmm2,%xmm1
.Ll94:
# [226] +foutputtable[6]*mul6
	movsd	48(%rax),%xmm2
	mulsd	120(%rcx),%xmm2
	addsd	%xmm1,%xmm2
.Ll95:
# [227] +foutputtable[7]*mul7;
	movsd	56(%rax),%xmm1
	mulsd	128(%rcx),%xmm1
	addsd	%xmm2,%xmm1
# Var modulator located in register xmm1
...
# [229] pa:=pa+freq2;
	...
	movsd	%xmm2,248(%rcx)
.Ll97:
# [238] if wavemode=0 then
	cmpl	$0,288(%rcx)
	jne	.Lj239
.Ll98:
# [240] if pa>wlength-0.5 then
	cvtsi2ssl	272(%rcx),%xmm0
	subss	_$FMSYNTH$_Ld14(%rip),%xmm0
	cvtss2sd	%xmm0,%xmm0
	comisd	248(%rcx),%xmm0
	jp	.Lj241
	jnb	.Lj241
.Ll99:
# [241] pa:=pa-wlength;
	cvtsi2sdl	272(%rcx),%xmm0
	movsd	248(%rcx),%xmm2
	subsd	%xmm0,%xmm2
	movsd	%xmm2,248(%rcx)
.Lj241:
.Ll100:
# [242] pa2:=pa+modulator;
	movsd	248(%rcx),%xmm0
	addsd	%xmm1,%xmm0
	movsd	%xmm0,256(%rcx)
.Ll101:
# [243] if pa2>wlength-1 then repeat pa2:=pa2-wlength until pa2<=wlength-1;
	movslq	272(%rcx),%rax
	leaq	-1(%rax),%rax
	cvtsi2sd	%rax,%xmm0
	comisd	256(%rcx),%xmm0
...
.Lj239:
.Ll102:
# [247] if adsrstate<5 then
	cmpl	$5,284(%rcx)
	jnl	.Lj258
.Ll103:
# [249] if pa>wlend-1 then repeat pa:=pa-wlend+wlstart until pa<=wlend;
	movslq	280(%rcx),%rax
	leaq	-1(%rax),%rax
	cvtsi2sd	%rax,%xmm0
	comisd	248(%rcx),%xmm0
...
.Lj258:
.Ll104:
# [253] if pa>=wlength-1 then pa:=wlength-1;
	movslq	272(%rcx),%rax
	leaq	-1(%rax),%rax
	cvtsi2sd	%rax,%xmm0
	comisd	248(%rcx),%xmm0
...
.Lj268:
.Ll105:
# [255] pa2:=pa+modulator;
	movsd	248(%rcx),%xmm0
	addsd	%xmm1,%xmm0
	movsd	%xmm0,256(%rcx)
.Ll106:
# [256] if pa2>wlend-1 then repeat pa:=pa-wlend+wlstart until pa<=wlend-1;
	movslq	280(%rcx),%rax
	leaq	-1(%rax),%rax
	cvtsi2sd	%rax,%xmm0
	comisd	256(%rcx),%xmm0
...
# [258] intpa:=round(pa2);
	...
	movl	%eax,292(%rcx)
.Ll108:
# [259] sample:=wptr[intpa];
	movq	136(%rcx),%rdx
	movslq	292(%rcx),%rax
# Var sample located in register xmm1
	movsd	(%rdx,%rax,8),%xmm1
.Ll109:
# [266] if adsrstate=5 then  // release
	cmpl	$5,284(%rcx)
	jne	.Lj290
.Ll110:
# [268] adsrval:=adsrval+ar4;
	movsd	144(%rcx),%xmm0
	addsd	200(%rcx),%xmm0
	movsd	%xmm0,144(%rcx)
.Ll111:
# [269] if ar4<0 then begin if adsrval<av4 then begin adsrval:=av4; adsrstate:=0; end; end
	movsd	200(%rcx),%xmm0
...
.Lj294:
.Ll112:
# [270] else begin if adsrval>av4 then begin adsrval:=av4; adsrstate:=0; end; end;
	movsd	144(%rcx),%xmm0
	comisd	208(%rcx),%xmm0
	jp	.Lj311
	jna	.Lj311
...
.Lj290:
.Ll113:
# [272] else if adsrstate=3 then  // release
	cmpl	$3,284(%rcx)
	jne	.Lj313
.Ll114:
# [274] adsrval:=adsrval+ar3;
	movsd	144(%rcx),%xmm0
	addsd	184(%rcx),%xmm0
	movsd	%xmm0,144(%rcx)
.Ll115:
# [275] if ar3<0 then begin if adsrval<av3 then begin adsrval:=av3; adsrstate:=4; end; end
	movsd	184(%rcx),%xmm0
	comisd	_$FMSYNTH$_Ld3(%rip),%xmm0
	jp	.Lj317
	jnb	.Lj317
...
.Lj317:
.Ll116:
# [276] else begin if adsrval>av3 then begin adsrval:=av3; adsrstate:=4; end; end;
	movsd	144(%rcx),%xmm0
	comisd	192(%rcx),%xmm0
	jp	.Lj334
	jna	.Lj334
...
.Lj313:
.Ll117:
# [278] else if adsrstate=2 then  // release
	cmpl	$2,284(%rcx)
	jne	.Lj336
.Ll118:
# [280] adsrval:=adsrval+ar2;
	movsd	144(%rcx),%xmm0
	addsd	168(%rcx),%xmm0
	movsd	%xmm0,144(%rcx)
.Ll119:
# [281] if ar2<0 then begin if adsrval<av2 then begin adsrval:=av2; adsrstate:=3; end; end
	movsd	168(%rcx),%xmm0
	comisd	_$FMSYNTH$_Ld3(%rip),%xmm0
	jp	.Lj340
	jnb	.Lj340
...
.Lj340:
.Ll120:
# [282] else begin if adsrval>av2 then begin adsrval:=av2; adsrstate:=3; end; end;
	movsd	144(%rcx),%xmm0
	comisd	176(%rcx),%xmm0
	jp	.Lj357
	jna	.Lj357
...
.Lj336:
.Ll121:
# [284] else if adsrstate=1 then  // release
	cmpl	$1,284(%rcx)
	jne	.Lj359
.Ll122:
# [286] adsrval:=adsrval+ar1;
	movsd	144(%rcx),%xmm0
	addsd	152(%rcx),%xmm0
	movsd	%xmm0,144(%rcx)
.Ll123:
# [287] if ar1<0 then begin if adsrval<av1 then begin adsrval:=av1; adsrstate:=2; end; end
	movsd	152(%rcx),%xmm0
	comisd	_$FMSYNTH$_Ld3(%rip),%xmm0
	jp	.Lj363
	jnb	.Lj363
...
.Lj363:
.Ll124:
# [288] else begin if adsrval>av1 then begin  adsrval:=av1; adsrstate:=2; end;  end;
	movsd	144(%rcx),%xmm0
	comisd	160(%rcx),%xmm0
	jp	.Lj374
	jna	.Lj374
...
.Lj311:
.Ll125:
# [291] if adsrstate<>0 then sample:=sample*flogtable[round(65535*((1-adsrbias)*adsrval)+adsrbias)] else sample:=0;
	cmpl	$0,284(%rcx)
	je	.Lj381
.Ll126:
	movsd	216(%rcx),%xmm2
...
.Ll129:
	movsd	232(%rcx),%xmm2
.Ll130:
# [294] sample:=sample*(1-keysense+vel*keysense);
...
# Var sample located in register xmm0
.Ll131:
# [295] sample:=sample*c6*expr;
	mulsd	40(%rcx),%xmm0
	mulsd	240(%rcx),%xmm0
# Var sample located in register xmm0
.Ll132:
# [296] if sample>1 then
...
_$FMSYNTH$_Ld8:
# value: 0d+3.4133333333333331E+002
	.byte	85,85,85,85,85,85,117,64
