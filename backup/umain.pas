...
for i:=0 to 3 do
  begin
    for j:=0 to 1 do
      ...
      controls[qn+8]:=qn+8; cx1[qn+0]:=160+qx; cx2[qn+0]:=223+qx; cy1[qn+0]:=110; cy2[qn+0]:=141; // mod0
      controls[qn+9]:=qn+9; cx1[qn+1]:=160+qx; cx2[qn+1]:=223+qx; cy1[qn+1]:=150; cy2[qn+1]:=181; // mod1
      controls[qn+10]:=qn+10; cx1[qn+2]:=160+qx; cx2[qn+2]:=223+qx; cy1[qn+2]:=190; cy2[qn+2]:=221; // mod2
      controls[qn+11]:=qn+11; cx1[qn+3]:=160+qx; cx2[qn+3]:=223+qx; cy1[qn+3]:=230; cy2[qn+3]:=261; // mod3
      controls[qn+12]:=qn+12; cx1[qn+4]:=270+qx; cx2[qn+4]:=333+qx; cy1[qn+4]:=110; cy2[qn+4]:=141; // mod4
      controls[qn+13]:=qn+13; cx1[qn+5]:=270+qx; cx2[qn+5]:=333+qx; cy1[qn+5]:=150; cy2[qn+5]:=181; // mod5
      controls[qn+14]:=qn+14; cx1[qn+6]:=270+qx; cx2[qn+6]:=333+qx; cy1[qn+6]:=190; cy2[qn+6]:=221; // mod6
      controls[qn+15]:=qn+15; cx1[qn+7]:=270+qx; cx2[qn+7]:=333+qx; cy1[qn+7]:=230; cy2[qn+7]:=261; // mod7
